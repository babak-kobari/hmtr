<?php
// ajab/Filter/File/Resize.php
/**
 * Zend Framework addition by ajab
 * 
 * @category   Ajab
 * @package    Ajab_Filter
 ...
 * @package    Ajab_Filter
 */
class Ajab_Filter_File_Resize implements Zend_Filter_Interface
{
    ...
    protected $_adapter = 'Ajab_Filter_File_Resize_Adapter_Gd';
    ...
    public function __construct($options = array())
    {
        ...
        if (isset($options['adapter'])) {
            if ($options['adapter'] instanceof Skoch_Filter_File_Resize_Adapter_Abstract) {
                ...
                if (substr($name, 0, 33) != 'Ajab_Filter_File_Resize_Adapter_') {
                    $name = 'Ajab_Filter_File_Resize_Adapter_' . ucfirst(strtolower($name));
                }
                $this->_adapter = $name;
            }
        }
