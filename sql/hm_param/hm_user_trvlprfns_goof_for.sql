...
--
-- Table structure for table `hm_user_trvlprfns_goof_for`
--

DROP TABLE IF EXISTS `hm_user_trvlprfns_goof_for`;
CREATE TABLE IF NOT EXISTS `hm_user_trvlprfns_goof_for` (
