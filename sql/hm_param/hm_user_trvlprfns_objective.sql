...
--
-- Table structure for table `hm_user_trvlprfns_objective`
--

DROP TABLE IF EXISTS `hm_user_trvlprfns_objective`;
CREATE TABLE IF NOT EXISTS `hm_user_trvlprfns_objective` (
