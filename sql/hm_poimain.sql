...
--
-- Table structure for table `hm_poimain`
--

DROP TABLE IF EXISTS `hm_poimain`;
CREATE TABLE IF NOT EXISTS `hm_poimain` (
  ...
  `poi_stay_type` int(11) NOT NULL,
  `poi_stay_calssification` varchar(10) NOT NULL,
  `poi_country` varchar(200) NOT NULL,
  ...
  `poi_location_type` int(5) NOT NULL,
